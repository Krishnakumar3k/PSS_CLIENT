    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.companyInfo}>
          <Text style={styles.companyName}>
            {data.addPvtLtd ? "PANORAMA SOFTWARE SOLUTIONS PVT LTD" : "PANORAMA SOFTWARE SOLUTIONS"}
          </Text>
          <Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.paragraph}>
          ...
          <Text>to {pronoun} work and responsibilities. </Text><Text>{pronounSubject} commitment to excellence has significantly contributed to the success of</Text>{" "}
          <Text>our team and the organization as a whole.</Text>
        </Text>
        <Text style={styles.paragraph}>
          <Text>{pronounSubject} has done an exemplary job while serving in this role. {pronounSubject} has always maintained a professional and</Text>{" "}
          <Text>courteous attitude while working with our company.</Text>
        </Text>

        <Text style={styles.paragraph}>
          <Text>{pronounSubject} decided to end {pronoun} employment with our company, and we wish {pronoun} all the best in future career</Text>{" "}
          <Text>opportunities.</Text>{" "}
        </Text>
        <Text style={{ ...styles.paragraph, marginBottom: 0, marginTop: 2}}>Please contact us for any additional information.</Text>
        ...
        >
          <View>
            ...
            <Text style={{ ...styles.paragraph, marginBottom: 1 }}>
              <Text style={styles.bold}>{data.addPvtLtd ? "Panorama Software Solution Pvt Ltd" : "Panorama Software Solution"} </Text>
            </Text>
            <Text style={{ ...styles.paragraph, marginBottom: 1 }}>
